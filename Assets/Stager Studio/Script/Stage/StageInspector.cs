	...
	public class StageInspector : MonoBehaviour {
		...
		public void UI_OnEndEdit_Note (string id) {
			...
			switch (id.ToLower()) {
				...
				case "click":
					...
					break;
				case "timing":
					map.SetNoteTimingID(GetSelectingIndex(), InspectorNote.GetTimingID());
					break;
				case "parama":
		...
		public void UI_OnEndEdit_Timing (string id) {
			...
			switch (id.ToLower()) {
				...
				case "duration":
					...
					break;
				case "timing":
					map.SetTimingTimingID(GetSelectingIndex(), InspectorTiming.GetTimingID());
					break;
				case "speed":
		...
		private void RefreshNoteInspector () {
			...
			try {
				...
				InspectorNote.SetTimingID(note.TimingID);
		...
		private void RefreshTimingInspector () {
			...
			try {
				...
				InspectorTiming.SetTimingID(timing.TimingID);
