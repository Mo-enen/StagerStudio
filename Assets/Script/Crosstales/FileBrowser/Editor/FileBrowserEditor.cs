...
namespace Crosstales.FB.EditorExtension
{
   ...
   public class FileBrowserEditor : Editor
   {
      ...
      public override void OnInspectorGUI()
      {
         ...
         customWrapper = EditorGUILayout.ObjectField("Custom Wrapper", script.CustomWrapper, typeof(Wrapper.BaseCustomFileBrowser), true);
         if (customWrapper != script.CustomWrapper)
         {
            script.CustomWrapper = (Wrapper.BaseCustomFileBrowser)customWrapper;
         ...
         legacyFolderBrowser = EditorGUILayout.Toggle(new GUIContent("Legacy Folder Browser", "Use the legacy folder browser (default: false)."), script.LegacyFolderBrowser);
