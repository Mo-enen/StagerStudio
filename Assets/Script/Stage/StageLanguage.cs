namespace StagerStudio.Stage {
	...
	public class StageLanguage : MonoBehaviour {
		...
		// API
		public List<SystemLanguage> AllLanguages => _AllLanguages ??= RefreshAllLanguageNames();
		...
		// Saving
		private readonly SavingInt LanguageIndex = new SavingInt("StageLanguage.LanguageIndex", -1);
